...
test("symbols", { skip: !hasSymbols }, function (t) {
  ...
  t.test(
    "toStringTag",
    { skip: !hasSymbols || typeof Symbol.toStringTag === "undefined" },
    function (st) {
      st.plan(1);
...
test("Map", { skip: typeof Map !== "function" }, function (t) {
  ...
  map.set(3, NaN);
  var expectedString =
    "Map (2) {" + inspect({ a: 1 }) + " => " + inspect(["b"]) + ", 3 => NaN}";
  t.equal(
    inspect(map),
    expectedString,
...
test("Strings", function (t) {
  ...
  t.equal(
    inspect(str, { quoteStyle: "single" }),
    "'" + str + "'",
    "primitive string shows as such, single quoted"
  );
  t.equal(
    inspect(str, { quoteStyle: "double" }),
    '"' + str + '"',
  ...
  t.equal(
    inspect(Object(str), { quoteStyle: "single" }),
    "Object(" + inspect(str, { quoteStyle: "single" }) + ")",
    "String object shows as such, single quoted"
  );
  t.equal(
    inspect(Object(str), { quoteStyle: "double" }),
    "Object(" + inspect(str, { quoteStyle: "double" }) + ")",
