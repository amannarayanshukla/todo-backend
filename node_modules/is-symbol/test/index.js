...
test("faked symbol values", function (t) {
  ...
  t.test(
    ...
    function (st) {
      ...
      st.equal(
        false,
        isSymbol(fakeSymbol),
        "object with fake Symbol @@toStringTag and valueOf returning a symbol is not a symbol"
      );
      var notSoFakeSymbol = {
        valueOf: function () {
          return 42;
      ...
      st.equal(
        false,
        isSymbol(notSoFakeSymbol),
        "object with fake Symbol @@toStringTag and valueOf not returning a symbol is not a symbol"
      );
      st.end();
    }
  );

  var fakeSymbolString = {
    toString: function () {
      return "Symbol(foo)";
    },
  };
  t.equal(
    false,
    isSymbol(fakeSymbolString),
    "object with toString returning Symbol(foo) is not a symbol"
  );
