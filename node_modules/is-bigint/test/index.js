...
test("faked BigInt values", function (t) {
  ...
  t.test(
    ...
    function (st) {
      ...
      st.equal(
        false,
        isBigInt(fakeBigInt),
        "object with fake BigInt @@toStringTag and valueOf returning a BigInt is not a BigInt"
      );
      ...
      st.equal(
        false,
        isBigInt(notSoFakeBigInt),
        "object with fake BigInt @@toStringTag and valueOf not returning a BigInt is not a BigInt"
      );
      st.end();
    }
  );
  ...
  t.equal(
    false,
    isBigInt(fakeBigIntString),
    "object with toString returning 42n is not a BigInt"
  );
