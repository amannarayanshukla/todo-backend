...
test("$NODE_PATH", function (t) {
  ...
  resolve(
    ...
    function (err, res) {
      ...
      t.equal(
        res,
        path.join(__dirname, "/node_path/x/aaa/index.js"),
        "aaa resolves"
      );
    }
  );
  ...
  resolve(
    ...
    function (err, res) {
      ...
      t.equal(
        res,
        path.join(__dirname, "/node_path/y/bbb/index.js"),
        "bbb resolves"
      );
    }
  );
  ...
  resolve(
    ...
    function (err, res) {
      ...
      t.equal(
        res,
        path.join(__dirname, "/node_path/x/ccc/index.js"),
        "ccc resolves"
      );
    }
  );
  ...
  resolve(
    ...
    function (err, res) {
      ...
      t.equal(
        res,
        path.resolve(__dirname, "..", "node_modules/tap", root),
        "tap resolves"
      );
    }
  );
