...
test("dotted paths", function (t) {
  t.equal(
    ...
    "%Object.prototype.toString% yields Object.prototype.toString"
  );
  t.equal(
    GetIntrinsic("Object.prototype.toString"),
    Object.prototype.toString,
  ...
  t.equal(
    ...
    "%Array.prototype.push% yields Array.prototype.push"
  );
  t.equal(
    GetIntrinsic("Array.prototype.push"),
    Array.prototype.push,
  ...
  test(
    "underscore paths are aliases for dotted paths",
    { skip: !Object.isFrozen || Object.isFrozen(Object.prototype) },
    function (st) {
      ...
      forEach(
        ...
        function (name) {
          ...
          st.equal(
            GetIntrinsic(name),
            original,
            name + " yields original Object.prototype.toString"
          );
        }
      );
      ...
      forEach(
        ...
        function (name) {
          ...
          st.equal(
            GetIntrinsic(name),
            original,
            name + " yields cached Object.prototype.propertyIsEnumerable"
          );
        }
      );
  ...
  test("dotted path reports correct error", function (st) {
    st["throws"](
      ...
      /%NonExistentIntrinsic%/,
      "The base intrinsic of %NonExistentIntrinsic.prototype.property% is %NonExistentIntrinsic%"
    );
    ...
    st["throws"](
      ...
      /%NonExistentIntrinsicPrototype%/,
      "The base intrinsic of %NonExistentIntrinsicPrototype.property% is %NonExistentIntrinsicPrototype%"
    );
...
test("accessors", { skip: !$gOPD || typeof Map !== "function" }, function (t) {
  ...
  t.equal(
    typeof actual.get,
    "function",
    "Map.prototype.size has a getter function"
  );
  t.equal(
    GetIntrinsic("%Map.prototype.size%"),
    actual.get,
    "%Map.prototype.size% yields the getter for it"
  );
  t.equal(
    GetIntrinsic("Map.prototype.size"),
    actual.get,
...
test("generator functions", { skip: !generatorFns.length }, function (t) {
  ...
  forEach(generatorFns, function (genFn) {
    ...
    t.ok(
      ...
      fnName + " instanceof %GeneratorFunction%"
    );
    t.ok(
      $isProto($GeneratorFunctionPrototype, genFn),
      "%Generator% is prototype of " + fnName
    );
    t.ok(
      $isProto($GeneratorPrototype, genFn.prototype),
      "%GeneratorPrototype% is prototype of " + fnName + ".prototype"
    );
  });
...
test("async functions", { skip: !asyncFns.length }, function (t) {
  ...
  forEach(asyncFns, function (asyncFn) {
    ...
    t.ok(
      ...
      fnName + " instanceof %AsyncFunction%"
    );
    t.ok(
      $isProto($AsyncFunctionPrototype, asyncFn),
      "%AsyncFunctionPrototype% is prototype of " + fnName
    );
  });
...
test(
  ...
  function (t) {
    ...
    forEach(asyncGenFns, function (asyncGenFn) {
      ...
      t.ok(
        asyncGenFn instanceof $AsyncGeneratorFunction,
        fnName + " instanceof %AsyncGeneratorFunction%"
      );
      t.ok(
        $isProto($AsyncGeneratorFunctionPrototype, asyncGenFn),
        "%AsyncGenerator% is prototype of " + fnName
      );
      t.ok(
        $isProto($AsyncGeneratorPrototype, asyncGenFn.prototype),
        "%AsyncGeneratorPrototype% is prototype of " + fnName + ".prototype"
      );
    });
