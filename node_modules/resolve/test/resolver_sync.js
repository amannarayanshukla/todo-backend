...
test("foo", function (t) {
  ...
  t.equal(resolve.sync("./foo", { basedir: dir }), path.join(dir, "foo.js"));

  t.equal(resolve.sync("./foo.js", { basedir: dir }), path.join(dir, "foo.js"));
  ...
  t.throws(
    ...
    },
    {
      name: "Error",
      message:
        "Cannot find module 'foo' from '" + path.join(dir, "bar.js") + "'",
    }
  );
...
test("mug", function (t) {
  var dir = path.join(__dirname, "resolver");
  t.equal(resolve.sync("./mug", { basedir: dir }), path.join(dir, "mug.js"));
