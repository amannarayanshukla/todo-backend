...
test("async foo", function (t) {
  ...
  resolve(
    "./foo",
    { basedir: dir, package: { main: "resolver" } },
  ...
  resolve(
    "./foo",
    { basedir: dir, filename: path.join(dir, "baz.js") },
    function (err, res) {
      if (err) t.fail(err);
      t.equal(res, path.join(dir, "foo.js"));
    }
  ...
  resolve("foo", { basedir: dir }, function (err) {
    t.equal(
      err.message,
      "Cannot find module 'foo' from '" + path.resolve(dir) + "'"
    );
  ...
  resolve(
    ...
    function (err) {
      t.equal(
        err.message,
        "Cannot find module 'foo' from '" + path.join(dir, "baz.js") + "'"
      );
    }
  );
});
...
test("bar", function (t) {
  ...
  resolve(
    "foo",
    { basedir: dir + "/bar", package: { main: "bar" } },
    function (err, res, pkg) {
      if (err) t.fail(err);
      t.equal(res, path.join(dir, "bar/node_modules/foo/index.js"));
...
test("biz", function (t) {
  ...
  resolve(
    "tiv",
    { basedir: dir + "/grux", package: { main: "grux" } },
    function (err, res, pkg) {
      if (err) t.fail(err);
      t.equal(res, path.join(dir, "tiv/index.js"));
  ...
  resolve(
    "tiv",
    { basedir: dir + "/garply", package: { main: "./lib" } },
    function (err, res, pkg) {
      if (err) t.fail(err);
      t.equal(res, path.join(dir, "tiv/index.js"));
      t.equal(pkg.main, "./lib");
  ...
  resolve(
    "grux",
    { basedir: dir + "/tiv", package: { main: "tiv" } },
    function (err, res, pkg) {
      if (err) t.fail(err);
      t.equal(res, path.join(dir, "grux/index.js"));
...
test("cup", function (t) {
  ...
  resolve(
    "./cup",
    { basedir: dir, extensions: [".js", ".coffee"] },
    function (err, res) {
      if (err) t.fail(err);
  ...
  resolve("./cup", { basedir: dir, extensions: [".js"] }, function (err, res) {
    t.equal(
      err.message,
      "Cannot find module './cup' from '" + path.resolve(dir) + "'"
    );
    t.equal(err.code, "MODULE_NOT_FOUND");
  });
  ...
  resolve(
    ...
    function (err, res) {
      t.equal(
        err.message,
        "Cannot find module './cup' from '" +
          path.join(dir, "cupboard.js") +
          "'"
      );
    }
  );
...
test("mug", function (t) {
  ...
  resolve(
    "./mug",
    { basedir: dir, extensions: [".coffee", ".js"] },
    function (err, res) {
      if (err) t.fail(err);
...
test("other path", function (t) {
  ...
  resolve("root", { basedir: dir }, function (err, res) {
    t.equal(
      err.message,
      "Cannot find module 'root' from '" + path.resolve(dir) + "'"
    );
    t.equal(err.code, "MODULE_NOT_FOUND");
  });
  ...
  resolve("zzz", { basedir: dir, paths: [otherDir] }, function (err, res) {
    t.equal(
      err.message,
      "Cannot find module 'zzz' from '" + path.resolve(dir) + "'"
    );
    t.equal(err.code, "MODULE_NOT_FOUND");
  });
});
...
test('#211 - incorrectly resolves module-paths like "." when from inside a folder with a sibling file of the same name', function (t) {
  ...
  resolve(
    "./",
    { basedir: path.join(dir, "same_names/foo") },
    function (err, res, pkg) {
      if (err) t.fail(err);
      t.equal(res, path.join(dir, "same_names/foo/index.js"));
    }
  ...
  t.test("with a fake directory", function (st) {
    ...
    resolve("./" + testFile + "/blah", function (err, res, pkg) {
      ...
      st.equal(
        err && err.code,
        "MODULE_NOT_FOUND",
        "error code matches require.resolve"
      );
      st.equal(
        err && err.message,
...
test("not a directory", function (t) {
  ...
  resolve(path, { basedir: __filename }, function (err, res, pkg) {
    ...
    t.equal(
      err && err.message,
      "Cannot find module '" + path + "' from '" + __filename + "'"
    );
