...
'gt gte lt lte ne in nin all regex size maxDistance minDistance'
  .split(' ')
  .forEach(function ($conditional) {
    Query.prototype[$conditional] = function () {
      ...
      var conds =
        this._conditions[path] === null || typeof this._conditions[path] === 'object'
...
Query.prototype.select = function select() {
  ...
  if (
    (('string' == type || utils.isArgumentsObject(arg)) && 'number' == typeof arg.length) ||
    Array.isArray(arg)
  ) {
...
function _pushMap(opts, map) {
  ...
  if (!(opts.sort instanceof Map)) {
    throw new TypeError(
      "Can't mix sort syntaxes. Use either array or " + 'object or map consistently',
    );
  }
...
Query.prototype.read = Query.prototype.setReadPreference = function (pref) {
  if (arguments.length > 1 && !Query.prototype.read.deprecationWarningIssued) {
    console.error(
      "Deprecation warning: 'tags' argument is not supported anymore in Query.read() method. Please use mongodb.ReadPreference object instead.",
    );
...
Query.prototype.findOneAndRemove = Query.prototype.findOneAndDelete = function (
  conditions,
  options,
  callback,
) {
