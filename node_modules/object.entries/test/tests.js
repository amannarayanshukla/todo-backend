...
module.exports = function (entries, t) {
  ...
  t.test(
    "non-enumerable properties are omitted",
    { skip: !Object.defineProperty },
    function (st) {
      var object = { a: a, b: b };
  ...
  t.test(
    "not-yet-visited keys deleted on [[Get]] must not show up in output",
    { skip: !define.supportsDescriptors },
    function (st) {
      var o = { a: 1, b: 2, c: 3 };
