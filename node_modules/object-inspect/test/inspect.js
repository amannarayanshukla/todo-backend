...
test(
  ...
  { skip: !hasSymbols || !utilInspect || !utilInspect.custom },
  function (t) {
    t.plan(4);
    ...
    obj[utilInspect.custom] = function custom() {
      return "symbol";
    };
    ...
    var falseResult =
      "[ { inspect: [Function: stringInspect]" +
      (utilInspect.custom
        ? ", [" + inspect(utilInspect.custom) + "]: [Function: custom]"
        : "") +
      " }, [] ]";
    ...
    t.equal(
      inspect([obj, []], { customInspect: "symbol" }),
      symbolFalseFallback
    );
    t.equal(inspect([obj, []], { customInspect: false }), falseResult);
  }
...
test("symbols", { skip: !hasSymbols }, function (t) {
  ...
  if (typeof Symbol.iterator === "symbol") {
    t.equal(
      inspect(obj),
      "{ a: 1, [Symbol(test)]: 2, [Symbol(Symbol.iterator)]: 3 }",
      "object with symbols"
    );
    t.equal(
      inspect([obj, []]),
