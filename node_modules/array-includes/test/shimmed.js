...
test("shimmed", function (t) {
  t.equal(
    ...
    1,
    "Array#includes has a length of 1"
  );
  ...
  t.test(
    ...
    function (et) {
      et.equal(
        false,
        isEnumerable.call(Array.prototype, "includes"),
        "Array#includes is not enumerable"
      );
      et.end();
    }
  );
  ...
  t.test("bad array/this value", { skip: !supportsStrictMode }, function (st) {
    st["throws"](
      function () {
        return Array.prototype.includes.call(undefined, "a");
      },
      TypeError,
    ...
    st["throws"](
      function () {
        return Array.prototype.includes.call(null, "a");
      },
      TypeError,
